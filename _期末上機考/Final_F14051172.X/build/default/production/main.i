...
int per_arrp[30] = { 783, 659, 659, 0, 698, 587, 587, 0, 523, 587, 659, 698, 783, 783, 783, 0,
783, 659, 659, 0, 698, 587, 587, 0, 523, 659, 783, 783, 659, 0
};
int wait[2] = {1};

int per_arrp1[19] = { 329, 392, 440, 440, 0, 440, 494, 523, 523, 0, 523, 587, 494, 494, 0, 440, 392, 440, 0
};
...
void main(void)
{
    ...
    while(1) {
        ...
        if (q == 1){
            if (strcmp("Mode1", str) == 0){
                ClearBuffer();
                mode1 = 1;
            } else if (strcmp("Mode2", str) == 0) {
                ClearBuffer();
                mode2 = 1;
            } else if (strcmp("Mode3", str) == 0) {
                ClearBuffer();
                mode3 = 1;
            }
        }
