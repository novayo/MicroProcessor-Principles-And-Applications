...
void Delay (int xc){
    T0CON = 0x84;
    if (xc == 1) TMR0 = 0xFFFF - 1 * 3125;
    else if (xc == 2) TMR0 = 0xFFFF - 2 * 3125;
    else if (xc == 3) TMR0 = 0xFFFF - 3 * 3125;
    else if (xc == 4) TMR0 = 0xFFFF - 4 * 3125;
    else if (xc == 5) TMR0 = 0xFFFF - 5 * 3125;
    else if (xc == 6) TMR0 = 0xFFFF - 6 * 3125;
    else if (xc == 7) TMR0 = 0xFFFF - 7 * 3125;
    else if (xc == 8) TMR0 = 0xFFFF - 8 * 3125;
    else if (xc == 9) TMR0 = 0xFFFF - 9 * 3125;
    else if (xc == 10) TMR0 = 0xFFFF - 10 * 3125;
    INTCONbits.TMR0IF = 0;
